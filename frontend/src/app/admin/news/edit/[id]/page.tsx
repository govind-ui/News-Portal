    ...
    const fetchArticle = async () => {
      try {
        ...
        if (res.ok) {
          ...
          setCategory(typeof data.category === 'object' ? data.category.name : data.category || '');
          ...
          setError(data.message || 'Failed to download news article.');
        }
      } catch (err) {
        setError('Error downloading news article details from the database.');
      } finally {
        setLoading(false);
      }
    };
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-gray-500 text-sm font-semibold">Downloading news article record...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-gray-200 pb-6 mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-1 text-sm lg:text-base">
            Revise details, classify categories, or toggle breaking alerts for your article.
          </p>
        </div>
        <button
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-4 space-y-6 lg:sticky lg:top-24">
              ...
              <div className="bg-slate-900 text-white rounded-2xl p-6 shadow-xl space-y-5">
                ...
                {/* Categories select options pills */}
                <div>
